	...
	<div class="wrap">
		<ul id="menu-main-nav" class="menu genesis-nav-menu menu-primary">
			...
			<li class="menu-item menu__join">
				<a href="<?php echo fulcrum_get_url_relative_to_home_url( 'membership' ); ?>" itemprop="url"><span itemprop="name"><i class="fa fa-code" aria-hidden="true"></i> Join</span></a>
			</li>
			<?php endif; ?>
			...
			<li class="menu-item menu__dashboard<?php if ( is_page( 'my-dashboard' ) ) { echo ' current-menu-item'; } ?>">
				<a href="<?php echo fulcrum_get_url_relative_to_home_url( 'my-dashboard' ); ?>" itemprop="url"><span itemprop="name"><i class="fa fa-dashboard" aria-hidden="true"></i> My Dashboard</span></a>
			</li>
			<?php endif; ?>
		</ul>
	</div>
