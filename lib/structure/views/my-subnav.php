	...
	<div class="wrap">
		<ul id="menu-secondary-nav" class="menu genesis-nav-menu menu-secondary">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<li class="menu-item menu__account<?php if ( is_page( 'account' ) ) { echo ' current-menu-item'; } ?>">
					<a href="<?php echo fulcrum_get_url_relative_to_home_url( 'account' ); ?>?action=subscriptions" itemprop="url"><span itemprop="name"><i class="fa fa-life-ring" aria-hidden="true"></i> My Subscription</span></a>
				</li>
			<?php endif; ?>
		</ul>
	</div>
